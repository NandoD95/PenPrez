...
function PrivatePolicy(){
    return(
        <div>
            ...
            <p>
                PenPrez operates the www.penprez.com website. This Privacy Policy outlines how we collect, use, and protect your personal information when you use our Service.

                1. INFORMATION WE COLLECT
                1.1 PERSONAL DATA
                We may collect personally identifiable information ("Personal Data") that you provide directly to us when you:

                Register for an account on our website.

                Subscribe to our newsletter.

                Contact us through forms or emails.
                ...
                2. USE OF DATA
                PenPrez uses the collected data for various purposes:
                ...
                If you are from the European Economic Area (EEA), PenPrez’s legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.

                PenPrez may process your Personal Data because:
