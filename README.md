# PenPrez
A marketing agency that handles all marketing related objectives such as SMS, SEO, EMAIL & SOCIAL MEDIA

## Manager
- [x] Create a new manager
- [x] Assign a manager to a Client
- [x] Remove a manager from a Client
- [x] Leave a review for clients to see and implement into their business 

## Client
- [x] Create a new client
- [x] Leave reviews for the manager handling their marketing
- [x] View all marketing objectives and their progree
- [x] Request changes to their marketing objectives
- [x] View all reviews left by other clients for a manager

## Review
- [x] Create a new review
- [x] View all reviews for a manager
- [x] View all reviews left by a client
